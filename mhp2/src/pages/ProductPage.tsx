...
import FlagshipModel from "@/components/product/FlagshipModel";
import HumanLensModel from "@/components/product/HumanLensModel";
import {
  Building2,
  Heart,
  ArrowRight,
...
/* ─── "For Whom" callout ─── */
const ForWhomBadge = ({ text, iconColor }: { text: string; iconColor: string }) => (
...
/* ─────────────────────────────────────────
   MODEL 1 — Full Health Buddy Centre
   ───────────────────────────────────────── */
/* FlagshipModel moved to src/components/product/FlagshipModel.tsx */
