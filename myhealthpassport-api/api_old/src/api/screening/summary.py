...
#         # Prepare dental screening report without strengths, needs_attention, created_at, and updated_at
#         dental_screening_report = {
#             "patient_concern": [],
#             "oral_examination": [],
#             "diagnosis": [],
...
#         # Prepare eye screening report without created_at and updated_at
#         eye_screening_report = {
...
#         if not lab_reports["needs_attention"]:
#             lab_reports["needs_attention"] = [""]
#         # Convert the smart scale record to dictionary for response, excluding created_at and updated_at
#         data_dict = {
#             "id": smart_scale_data.id,
#             "student_id": smart_scale_data.student.id,
#             "school_id": smart_scale_data.school.school_id,
...
#             "skeletal_muscle_mass_kg": smart_scale_data.skeletal_muscle_mass_kg,
#             "health_score": smart_scale_data.physical_score,
#             "physical_screening_report": physical_screening_report,
#             "status": physical_screening_status,
#             "overall_summary": physical_screening_summary
#         }
