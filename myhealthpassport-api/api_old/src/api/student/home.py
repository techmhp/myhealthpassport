...
#     if current_user.get("user_role") in {OnGroundTeamRoles.REGISTRATION_TEAM, OnGroundTeamRoles.CAMP_COORDINATOR, 
#                                         AdminTeamRoles.SUPER_ADMIN, AdminTeamRoles.PROGRAM_COORDINATOR} or \
#        current_user.get("user_role") in role_status_map:
...
#                     # "nutrition_analysis_status": bool(nutritional_analysis_status),
#                     # "psychological_analysis_status": bool(psychological_analysis_status)
        ...
        async with in_transaction():
            ...
            if update_data.parent_details:
                ...
                if parent_model:
                    ...
                    if address_data.pincode is not None:
                        parent_model.pincode = address_data.pincode
...
# @router.get("/student/{student_code}/screening")
# async def student_screening(student_code: str):
#     data_dict = {
#         "status": True,
#         "message": "Student Screening Details",
#         "data": {
#             "screening": [
#                 {
#                     "screening_id": 1,
#                     "student_code": "STU-001",
#                     "screening_type": "General Health Checkup",
...
#                 "notes_id": 1,
#                 "student_code": "STU-001",
#                 "final_notes": "No allergies reported",
#             },
#         },
#     }
#     response_obj = StandardResponse(**data_dict)
...
# @router.put("/student/{student_code}/screening")
# async def student_screening_update(student_code: str):
#     data_dict = {
#         "status": True,
#         "message": "Update Student Screening Details",
#         "data": {},
#     }
...
# from src.models.screening_models import BehaviouralScreening, DentalScreening, EyeScreening, NutritionScreening
...
# router = APIRouter()
#
# async def get_student_by_code(student_code: str) -> Students:
#     """Helper function to fetch student by student_code."""
#     try:
#         student = await Students.get_or_none(aadhaar_no=student_code).prefetch_related(
#             "behavioural_screenings__doctor",
#             "dental_screenings__doctor",
#             "eye_screenings__doctor",
#             "nutrition_screenings__doctor"
#         )
#         if not student:
#             raise HTTPException(
...
#         )
#
# @router.get("/student/{student_code}/screening", status_code=200)
# async def student_screening(student_code: str) -> StandardResponse:
#     """
#     Retrieve screening details for a student by student_code.
#     Returns screening data including behavioural, dental, eye, and nutrition screenings.
#     """
...
#     notes: Dict[str, Any] = {}
#
#     # Fetch Behavioural Screenings
#     async for screening in student.behavioural_screenings:
#         screening_data.append({
#             "screening_id": screening.bs_id,
#             "student_code": student_code,
#             "screening_type": "Behavioural",
#             "question": "Behavioural observations",
#             "question_id": screening.bs_id,
#             "answer": screening.behavioural_observations or "N/A",
#             "doctor": f"{screening.doctor.first_name} {screening.doctor.last_name}" if screening.doctor else "N/A"
#         })
#         if screening.note:
#             notes.update({
#                 "notes_id": screening.bs_id,
#                 "student_code": student_code,
#                 "final_notes": screening.note
#             })
#
#     # Fetch Dental Screenings
#     async for screening in student.dental_screenings:
#         screening_data.append({
#             "screening_id": screening.ds_id,
#             "student_code": student_code,
#             "screening_type": "Dental",
#             "question": "Oral examination",
#             "question_id": screening.ds_id,
#             "answer": screening.oral_examination or "N/A",
#             "doctor": f"{screening.doctor.first_name} {screening.doctor.last_name}" if screening.doctor else "N/A"
#         })
#         if screening.examination_note:
#             notes.update({
#                 "notes_id": screening.ds_id,
#                 "student_code": student_code,
#                 "final_notes": screening.examination_note
#             })
#
#     # Fetch Eye Screenings
#     async for screening in student.eye_screenings:
#         screening_data.append({
#             "screening_id": screening.es_id,
#             "student_code": student_code,
#             "screening_type": "Eye",
#             "question": "Vision assessment",
#             "question_id": screening.es_id,
#             "answer": f"Left: {screening.vision_lefteye_res}, Right: {screening.vision_righteye_res}" if (screening.vision_lefteye_res or screening.vision_righteye_res) else "N/A",
#             "doctor": f"{screening.doctor.first_name} {screening.doctor.last_name}" if screening.doctor else "N/A"
#         })
#         if screening.additianal_note:
#             notes.update({
#                 "notes_id": screening.es_id,
#                 "student_code": student_code,
#                 "final_notes": screening.additianal_note
#             })
#
#     # Fetch Nutrition Screenings
#     async for screening in student.nutrition_screenings:
#         screening_data.append({
#             "screening_id": screening.ns_id,
#             "student_code": student_code,
#             "screening_type": "Nutrition",
#             "question": "General health signs",
#             "question_id": screening.ns_id,
#             "answer": screening.general_signs or "N/A",
#             "doctor": f"{screening.doctor.first_name} {screening.doctor.last_name}" if screening.doctor else "N/A"
#         })
#         if screening.note:
#             notes.update({
#                 "notes_id": screening.ns_id,
#                 "student_code": student_code,
#                 "final_notes": screening.note
#             })
#
...
#     }
#
#     return StandardResponse(**data_dict)
#
# @router.put("/student/{student_code}/screening", status_code=200)
# async def student_screening_update(student_code: str) -> StandardResponse:
#     """
#     Update screening details for a student by student_code.
#     This is a placeholder implementation; actual update logic would depend on the request body.
#     """
#     await get_student_by_code(student_code)  # Verify the student exists
#
#     data_dict = {
#         "status": True,
#         "message": "Update Student Screening Details",
