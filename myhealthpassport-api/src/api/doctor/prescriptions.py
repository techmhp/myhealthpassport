...
# ===================================================================
# MODIFIED: GET DENTAL PRESCRIPTIONS (with Academic Year Filter)
# ===================================================================
...
async def get_dental_screening(
    ...
    try:
        ...
        # Fetch the dental screening record with academic year filter
        dental_screening = await DentalReport.filter(
            year_filter,
            student_id=student_id
        ).prefetch_related("student", "consultant_user").order_by("-created_at").first()
...
# ===================================================================
# MODIFIED: GET EYE PRESCRIPTIONS (with Academic Year Filter)
# ===================================================================
@router.get("/eye-prescriptions/{student_id}", response_model=StandardResponse)
async def get_eye_screening(
    student_id: int,
    academic_year: Optional[str] = Query(
        None,
        description="Academic year in format 'YYYY-YYYY' (e.g., '2024-2025'). Defaults to current year.",
    ...
    try:
        ...
        # Fetch the eye screening record with academic year filter
        eye_screening = await EyeReport.filter(
            year_filter,
            student_id=student_id
        ).prefetch_related("student", "consultant_user").order_by("-created_at").first()
...
# ===================================================================
# MODIFIED: GET PSYCHOLOGIST PRESCRIPTIONS (with Academic Year Filter)
# ===================================================================
@router.get("/psychologist-prescriptions/{student_id}", response_model=StandardResponse)
async def get_psychology_screening(
    student_id: int,
    academic_year: Optional[str] = Query(
        None,
        description="Academic year in format 'YYYY-YYYY' (e.g., '2024-2025'). Defaults to current year.",
    ...
    try:
        ...
        # Fetch the psychologist screening record with academic year filter
        psychologist_screening = await PsychologistReport.filter(
            year_filter,
            student_id=student_id
        ).prefetch_related("student", "consultant_user").order_by("-created_at").first()
...
# ===================================================================
# MODIFIED: GET PEDIATRICIAN PRESCRIPTIONS (with Academic Year Filter)
# ===================================================================
@router.get("/pediatrician-prescriptions/{student_id}", response_model=StandardResponse)
async def get_pediatrician_screening(
    student_id: int,
    academic_year: Optional[str] = Query(
        None,
        description="Academic year in format 'YYYY-YYYY' (e.g., '2024-2025'). Defaults to current year.",
    ...
    try:
        ...
        # Fetch the pediatrician screening record with academic year filter
        pediatrician_screening = await PediatricianReport.filter(
            year_filter,
            student_id=student_id
        ).prefetch_related("student", "consultant_user").order_by("-created_at").first()
