...
# ===================================================================
# MODIFIED: GET ATTENDANCE LIST (with Academic Year Filter)
# ===================================================================
@router.get("/{school_id}/attendance-list", response_model=StandardResponse)
async def get_attendance_list(
    school_id: int,
    ...
    # Fetch the user's assignments with academic year filter
    ...
    # Fetch attendance records for the requested school_id with academic year filter
    query = AttendanceStatus.filter(
        year_filter,
        student__school_students__school_id=school_id,
        date__lte=today
