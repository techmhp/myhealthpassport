...
import TwoPhaseModelSection from "@/components/marketing/csr/TwoPhaseModelSection";
import HealthPassportMockup from "@/components/marketing/HealthPassportMockup";
import ImpactCalculator from "@/components/marketing/csr/ImpactCalculator";
import CSRPartnerDialog from "@/components/marketing/csr/CSRPartnerDialog";
      ...
      <footer className="py-8 border-t border-border">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-2">
            &copy; {new Date().getFullYear()} My Health Passport. All rights reserved.
          </p>
        </div>
      </footer>
