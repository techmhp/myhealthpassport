...
import NutritionalAnalysis from '@/components/ScreeningAnalyst/NutritionalAnalysis';
import PsychologistAnalysis from '@/components/ScreeningAnalyst/PsychologistAnalysis';
...
const StudentInfo = () => {
  ...
  useEffect(() => {
    ...
    if (loginUser.user_role === 'PSYCHOLOGIST') {
      setActiveTab('Psychologist-Analysis');
    } else if (loginUser.user_role === 'NUTRITIONIST') {
      setActiveTab('Nutritional-Analysis');
    } else if (loginUser.user_role === 'MEDICAL_OFFICER') {
      setActiveTab('Overall-Summary');
    }
  ...
  const tabConfigurations = {
    NUTRITIONIST: [
      { name: 'Nutritional Screening', id: 'Nutritional-Screening', status: null },
      ...
      { name: 'Analysis', id: 'Nutritional-Analysis', status: student_details?.nutrition_analysis_status },
    ],
    PSYCHOLOGIST: [
      { name: 'Psychologist Screening', id: 'Psychologist-Screening', status: null },
      { name: "Parent's Response", id: 'Parents-Response', status: null },
      { name: "Teacher's Response", id: 'Teachers-Response', status: null },
      { name: 'Analysis', id: 'Psychologist-Analysis', status: student_details?.psychological_analysis_status },
    ],
    MEDICAL_OFFICER: [
      { name: 'Overall Summary', id: 'Overall-Summary', status: null },
        ...
        <div className="px-2 sm:px-6 md:px-10 lg:px-14 grid gap-4 md:gap-8 lg:gap-13">
          <div className="flex">
            <Breadcrumbs
              items={[
                {
                  ...
                  href: `/analyst/roster/${school.school_id}`,
                  current: false,
                },
                {
                  name: student_details?.identity_details
                    ...
                    : '',
                  href: `/analyst/roster/${school.school_id}/class/${student_details?.identity_details?.class_room}-${student_details?.identity_details?.section}`,
                  current: true,
                },
                {
              ...
              homeLabel="Roster"
              homeHref={`/analyst/roster/${school.school_id}`}
            />
