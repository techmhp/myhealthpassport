    ...
    <>
      ...
      <div className="px-[90px] py-[27px]">
        <div className="mb-5">
          <Breadcrumbs
            items={[
              ...
              {
                name: student_details?.identity_details ? `${student_details?.identity_details?.class_room}-${student_details?.identity_details?.section}` : '',
                href: `/onground/roster/${schoolid}/class/${student_details?.identity_details?.class_room}-${student_details?.identity_details?.section}`,
                current: true,
              },
              {
        ...
        <div className="bg-white rounded-lg">
          {student.status ? <StudentProfileForm school={school} details={student} /> : ''}
        </div>
      </div>
    </>
  );
