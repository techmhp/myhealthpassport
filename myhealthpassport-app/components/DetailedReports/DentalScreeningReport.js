        ...
        <>
          <div className="mb-5 mt-5 flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-5">
            ...
            <button
              ...
              className="w-full sm:w-auto rounded-[5px] cursor-pointer bg-indigo-500 px-5 py-2 text-sm font-normal text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
