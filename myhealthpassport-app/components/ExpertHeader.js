  ...
  return (
    <div className="w-full">
      <div className="flex items-center gap-x-2 sm:gap-x-4 md:gap-x-6">
        <Image alt="profile" src={isValidUrl(expertDetails?.profile_image_url) ? expertDetails?.profile_image_url : "/iconx/profile-image.svg"} className="size-12 sm:size-14 md:size-16 rounded-full" width={102} height={102} />
