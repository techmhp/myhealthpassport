          ...
          {stats.map((stat, index) => {
            ...
            return (
              <AnimatedSection key={index} delay={index * 100}>
                <div className="group relative bg-brand/5 p-6 sm:p-8 rounded-2xl border border-brand/15 hover:border-primary/50 transition-all duration-300 hover:shadow-card h-full">
                  ...
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 bg-brand/15 rounded-xl flex items-center justify-center">
